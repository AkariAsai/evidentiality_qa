...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--decoder_dir', type=str, default=None,
                    help='Use trained decoder')                       
        self.parser.add_argument('--model_name', type=str, default=None,
                    help='Use trained decoder')         
        self.parser.add_argument('--metric', type=str, default='em', help='evaluation metric')
        self.parser.add_argument('--answer_maxlength_eval', type=int, default=50, 
                        help='maximum number of tokens during evaluation')
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument('--n_gpus', type=int, default='none', help='# of GPUs used for training.')
        # dataset parameters
